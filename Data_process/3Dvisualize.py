...
# # Background_0004_2025_02_04_00_00_12.h5
# # file_path = 'C:/Users/bubbl/Desktop/Contest/mmWaveAI/K60168A_Dongle/KSOC_Tool/Collect_RDI/Collect_RDI/Record/RDIPHD/Distancetest_nothing/Background_0001_2025_02_03_23_59_48.h5'
...
# # 初始化 Slider
# ax_slider = plt.axes([0.2, 0.02, 0.6, 0.03])  # (左, 底, 寬度, 高度)
...
#     # 設定點的大小 (依據信號強度)
#     if peak_data:
#         intensities = np.array([p[3] for p in peak_data])
#         print(intensities)
#         sizes = 50 + 200 * (intensities - intensities.min()) / (intensities.max() - intensities.min() + 1e-6)

#         for i, (x, y, z, intensity) in enumerate(peak_data):
#             ax.scatter(x*20, y*20, z*20, marker='o', s=sizes[i], label=f'P{i+1} ({x:.2f}, {y:.2f}, {z:.2f})')
